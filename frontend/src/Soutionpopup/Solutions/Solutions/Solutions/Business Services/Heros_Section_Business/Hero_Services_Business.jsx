...
import "./Hero_Services_Business.css";
import { GoArrowDown } from "react-icons/go";
import bgImage from "../../../assets/images/business-servcies.jpg";
      ...
      <div className="hero-inner">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="max-w-3xl mt-4">
           ...
           In the service industry, your product is your people and your time. Business Services ERP centralizes project management, financial tracking, and client relations into one high-performance platform. From AI-assisted resource planning to automated global billing, empower your firm to deliver premium value while managing your operations from a single dashboard.
            </p>
          </div>
