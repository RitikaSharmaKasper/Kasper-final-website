...
import "./Hero_Services_IT.css";
import { GoArrowDown } from "react-icons/go";
import bgImage from "../../../assets/images2/it-1.jpg";
        ...
        IT & ITES
          ...
          <div className="max-w-3xl mt-4">
            <p className="text-base text-white leading-relaxed tracking-wide">
             IT services aren't just about execution—they are about ownership and intelligence. MUN-C IT & ITeS ERP centralizes service delivery, resource management, and cybersecurity into one high-velocity platform. From AI-driven incident resolution to global cloud orchestration, empower your IT firm to lead the digital era while managing complexity from a single, secure dashboard.
            </p>
          </div>
