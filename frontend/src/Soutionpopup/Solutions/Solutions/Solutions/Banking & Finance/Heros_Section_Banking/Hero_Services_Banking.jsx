...
import "./Hero_Services_Banking.css";
import { GoArrowDown } from "react-icons/go";
import bgImage from "../../../assets/images2/banking-1.jpg";
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="max-w-3xl mt-4">
            <p className="text-base text-white leading-relaxed tracking-wide">
              In the financial world, trust is built on uptime and accuracy.  Banking & Finance ERP centralizes core banking operations, risk assessment, and regulatory reporting into one fortress-grade platform. From AI-powered credit underwriting to seamless digital payments, empower your financial institution to scale with confidence while managing total security from a single dashboard.
            </p>
          </div>
