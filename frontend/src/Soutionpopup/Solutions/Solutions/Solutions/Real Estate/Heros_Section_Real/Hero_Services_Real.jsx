...
import "./Hero_Services_Real.css";
import { GoArrowDown } from "react-icons/go";
import bgImage from "../../../assets/images2/real-1.jpg";
      ...
      <div className="hero-inner">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="max-w-3xl mt-4">
            ...
            The real estate market moves fast, and manual tracking slows you down. MUN-C Real Estate ERP centralizes lead management, unit inventory, and construction milestones into one powerful platform. From automated payment demands to channel partner transparency, empower your real estate business to close deals faster while managing your portfolio from a single dashboard.
            </p>
          </div>
