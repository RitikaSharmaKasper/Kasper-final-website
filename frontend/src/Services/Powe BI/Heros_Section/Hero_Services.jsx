...
import { GoArrowDown } from "react-icons/go";import heroBg from "/src/assets/images2/power bi.jpg";
  ...
  <div className="hero-inner">
    <div className="flex flex-col items-center text-center">
      <h1 className="text-4xl font-semibold text-white">
       MICROSOFT POWER BI IMPLEMENTATION AND
ANALYTICS SOLUTIONS
      </h1>

      <div className="max-w-3xl mt-4">
        <p className="text-base text-white leading-relaxed tracking-wide">
          Kasper Infotech helps businesses implement Microsoft Power BI to transform raw data into
meaningful insights. Our solutions enable organizations to analyze data, create interactive
dashboards, and make faster business decisions using powerful data analytics and visualization
tools.
        </p>
      </div>
