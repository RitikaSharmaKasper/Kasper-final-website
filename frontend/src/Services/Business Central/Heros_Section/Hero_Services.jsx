...
import heroBg from "/src/assets/images2/business central.jpg";

// import heroBg from "/src/assets/images2/Microsoft CRM.jpg";
  ...
  <div className="hero-inner">
    <div className="flex flex-col items-center text-center">
      <h1 className="text-4xl font-semibold text-white">
        Microsoft Dynamics 365 Business Central Implementation Services 
      </h1>

      <div className="max-w-3xl mt-4">
        <p className="text-base text-white leading-relaxed tracking-wide">
         Kasper Infotech helps businesses implement Microsoft Dynamics 365 Business Central to manage finance, operations, and business processes in one system. This solution helps organizations simplify daily operations, improve financial control, and gain better visibility across their entire business.
        </p>
      </div>
