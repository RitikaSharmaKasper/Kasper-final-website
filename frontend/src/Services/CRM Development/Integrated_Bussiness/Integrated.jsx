 ...
 <div style={{background:"white"}}>
    <section className="why-choose">
      <div className="why_choose-content">
        <h2 className="why-main-heading">How CRM Software Improves Customer Management</h2>
          ...
          <div className="why-right">
            <div className="why-feature">
              ...
              <div>
                ...
                <p>Centralized customer information helps teams understand clients better and deliver more
personalized experiences.</p>
            ...
            <div className="why-feature">
              ...
              <div>
                ...
                <p>Managers get clear insights into sales activities, customer engagement, and business
performance.</p>
              </div>
            </div>
            ...
            <div className="why-feature">
              ...
              <div>
                ...
                <p>Automation and centralized data reduce manual work and improve overall business
productivity.</p>
              </div>
            </div>
          </div>
