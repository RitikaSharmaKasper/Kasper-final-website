...
import heroBg from "/src/assets/images2/qcs.jpg";
const Hero_Services = () => {
      ...
      <div className="hero-inner">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-4xl font-semibold text-white">
                      ...
                      D365QCS™ QUALITY AND COMPLIANCE MANAGEMENT SYSTEM 
          </h1>

          <div className="max-w-3xl mt-4">
            <p className="text-base text-white leading-relaxed tracking-wide">
           Kasper Infotech provides D365QCS™, a powerful solution designed to
              manage quality control, compliance, and regulatory processes. It
              helps businesses maintain standards, track deviations, and ensure
              product quality across operations with complete visibility and
              control.
