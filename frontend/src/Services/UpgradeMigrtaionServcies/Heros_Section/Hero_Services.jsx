...
import heroBg from "/src/assets/images2/upgrade and migration.jpg";
      ...
      <div className="hero-inner">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-4xl font-semibold text-white uppercase">
            Microsoft Dynamics Upgrade and Migration Services
          </h1>

          <div className="max-w-3xl mt-4">
            <p className="text-base text-white leading-relaxed tracking-wide">
              Kasper Infotech helps businesses upgrade and migrate their
              Microsoft Dynamics systems to the latest versions and cloud
              platforms. Our services ensure smooth transition, improved
              performance, and keep your business data secure.
            </p>
          </div>
