...
import heroBg from "/src/assets/images2/Business consulting.jpg";
const Hero_Services = () => {
...
BUSINESS CONSULTING AND PROJECT PLANNING SERVICES 
      </h1>

      <div className="max-w-3xl mt-4">
        <p className="text-base text-white leading-relaxed tracking-wide">
          Kasper Infotech helps businesses plan, manage, and execute projects efficiently with expert
consulting services. We guide organizations in strategy, budgeting, and execution, ensuring
smooth project delivery, better resource utilization, and successful business outcomes.
        </p>
      </div>
