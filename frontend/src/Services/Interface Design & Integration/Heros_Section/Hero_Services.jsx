...
import heroBg from "/src/assets/images2/interface design and integartion.jpg";
const Hero_Services = () => {
  ...
  <div className="hero-inner">
    <div className="flex flex-col items-center text-center">
      <h1 className="text-4xl font-semibold text-white">
       IINTERFACE DESIGN AND SYSTEM AND INTEGRATION SERVICES 
      </h1>

      <div className="max-w-3xl mt-4">
        <p className="text-base text-white leading-relaxed tracking-wide">
          Kasper Infotech provides interface design and integration services to connect different business
systems and create smooth user experiences. We help businesses integrate applications,
improve data flow, and design simple interfaces that make systems easy to use and manage.
        </p>
      </div>
