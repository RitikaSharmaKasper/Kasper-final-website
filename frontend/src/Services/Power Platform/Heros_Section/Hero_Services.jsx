...
import heroBg from "/src/assets/images2/power platform.jpg";
const Hero_Services = () => {
    ...
    <div className="flex flex-col items-center text-center">
      ...
      <div className="max-w-3xl mt-4">
        <p className="text-base text-white leading-relaxed tracking-wide">
          Kasper Infotech helps businesses implement Microsoft Power Platform to build applications,
automate workflows, analyze data, and improve productivity. This powerful platform allows
organizations to create custom solutions quickly.
        </p>
      </div>
