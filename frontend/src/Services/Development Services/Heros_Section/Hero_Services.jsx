...
import heroBg from "/src/assets/images2/development services.jpg";
const Hero_Services = () => {
      ...
      <div className="hero-inner">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-4xl font-semibold text-white">
                     ...
                     SOFTWARE DEVELOPMENT SERVICES FOR MODERN BUSINESS SOLUTIONS
          </h1>

          <div className="max-w-3xl mt-4">
            <p className="text-base text-white leading-relaxed tracking-wide">
                         Kasper Infotech provides development services to build reliable,
              scalable, and high- performance software solutions. We help
              businesses create applications that support operations, improve
              efficiency, and adapt to changing needs using modern technologies
