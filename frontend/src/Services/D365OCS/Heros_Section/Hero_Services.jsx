...
import heroBg from "/src/assets/images2/ocs.jpg";
const Hero_Services = () => {
      ...
      <div className="hero-inner">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-4xl font-semibold text-white">
            ...
            D365OCS™ SOLUTION FOR COMPELETE OPERATIONAL CONTROL
          </h1>

          <div className="max-w-3xl mt-4">
            <p className="text-base text-white leading-relaxed tracking-wide">
            Kasper Infotech provides D365OCS™, a powerful solution built on
              Microsoft Dynamics to manage operations, compliance, supply chain,
              and assets in one system. It helps businesses improve visibility,
              maintain standards, and streamline processes across different
              departments.
