...
import heroBg from "/src/assets/images2/customer engage.jpg";
...
const Hero_Services = () => {
  ...
  <div className="hero-inner">
    <div className="flex flex-col items-center text-center">
      <h1 className="text-4xl font-semibold text-white Sentence case">
       Microsoft CRM Implementation Services
      </h1>

      <div className="max-w-3xl mt-4">
        <p className="text-base text-white leading-relaxed tracking-wide">
          Kasper Infotech helps businesses manage customer relationships and sales and marketing and service activities in one platform. This solution helps track interactions and improve customer experience and build stronger business relationships.
        </p>
      </div>
