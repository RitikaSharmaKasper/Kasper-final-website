...
IMPLEMENTATION SERVICES
      ...
      <div className="max-w-3xl mt-4">
        <p className="text-base text-white leading-relaxed tracking-wide">
          Kasper Infotech provides Microsoft Dynamics 365 Finance and Operations services to help
businesses manage finance, supply chain, and operations in one intelligent platform. Our
solutions improve visibility, automate processes, and help organizations make better business
decisions.
        </p>
      </div>
