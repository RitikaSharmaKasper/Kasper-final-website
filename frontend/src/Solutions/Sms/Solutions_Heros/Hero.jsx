...
import "./SMSHero.css";
import sms_dash from "../../../assets/images2/sms_dash.png";
    ...
    <section className="hero-solutions">
      <div className="hero-inner">
        ...
        <p className="hero-desc">
          Modern institutions need connectivity, transparency, and organized data. MUN-C Smart School Management System centralizes student admissions, academic grading, fee collection, and parent-teacher communication into one powerful platform. Track attendance in real time, automate examination results, manage staff payroll, and streamline campus security from a single dashboard.
        </p>
...
>
  <span className="btn-content">Contact Us</span>
        ...
        <div className="hero-dashboard">
          <img src={sms_dash} alt="SMS Dashboard" />
        </div>
