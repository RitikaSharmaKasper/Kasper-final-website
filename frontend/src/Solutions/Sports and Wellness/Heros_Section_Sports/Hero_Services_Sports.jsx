...
import "./Hero_Services_Sports.css";
import { GoArrowDown } from "react-icons/go";
import bgImage from "../../../assets/images2/sports-1.jpg";
    ...
    >
      ...
      Sports & Wellness ERP
          ...
          <div className="max-w-3xl mt-4">
            ...
            Modern fitness centers demand more than just equipment—they demand data. MUN-C Sports & Wellness ERP centralizes member management, workout tracking, and facility scheduling into one powerful platform. From AI-driven nutrition plans to biometric access control, empower your fitness business to deliver professional results while automating your operations from a single dashboard.
            </p>
          </div>
