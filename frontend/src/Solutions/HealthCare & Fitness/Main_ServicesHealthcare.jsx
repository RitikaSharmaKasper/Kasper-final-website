...
import Hero_Services_Health from "./Heros_Section_HealthCare/Hero_Services_Health";
...
const Main_ServicesHealthcare = () => {
  return (
<>

<Hero_Services_Health/>
...
export default Main_ServicesHealthcare;