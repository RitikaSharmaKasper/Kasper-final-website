...
import "./Hero_Services_Social.css";
import { GoArrowDown } from "react-icons/go";
import bgImage from "../../../assets/images2/socialmedia-1.jpg";
      ...
      <div className="hero-inner">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-4xl font-semibold text-white">
             Social & Networking ERP
          </h1>

          <div className="max-w-3xl mt-4">
            <p className="text-base text-white leading-relaxed tracking-wide">
              Modern communication transcends simple messaging—it’s about building a digital home. MUN-C Social & Networking ERP centralizes community management, real-time engagement, and secure networking into one powerful platform. From AI-curated feeds to encrypted private hubs, empower your community to thrive while you control the ecosystem from a single, intuitive dashboard.
            </p>
          </div>
