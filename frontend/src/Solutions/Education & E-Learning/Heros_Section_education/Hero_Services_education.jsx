...
import "./Hero_Services_education.css";
import { GoArrowDown } from "react-icons/go";
import bgImage from "../../../assets/images/education.jpg";
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="max-w-3xl mt-4">
            <p className="text-base text-white leading-relaxed tracking-wide">
              E-Learning ERP centralizes curriculum management, interactive teaching, and student analytics into one high-velocity platform. From AI-driven personalized tutoring to global virtual classrooms, empower your institution to inspire the next generation while managing your campus from a single dashboard.
            </p>
          </div>
