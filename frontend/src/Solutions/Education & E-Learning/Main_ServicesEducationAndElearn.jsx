...
import Hero_Services_education from "./Heros_Section_education/Hero_Services_education";
...
const Main_ServicesEducationAndElearn = () => {
  return (
<>

<Hero_Services_education/>
...
export default Main_ServicesEducationAndElearn