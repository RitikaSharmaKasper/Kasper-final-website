...
import Hero_Services_Ecommerce from "./Heros_Section_EC/Hero_Services_Ecommerce";
...
const Main_ServicesECommerce= () => {
  return (
<>

<Hero_Services_Ecommerce/>
...
export default Main_ServicesECommerce;